...
public class AiStructuredService {
    ...
    public void streamStructuredDiagnosis(String symptoms, List<Map<String, String>> history,
        ...
        try {
            ...
            String jsonBody = objectMapper.writeValueAsString(
                    buildRequestBody(symptoms, safeHistory, true));
    ...
    /** 同步 HTTP 调用 */
    private String callApi(String symptoms, List<Map<String, String>> history, boolean stream) {
        ...
        try {
            ...
            String body = objectMapper.writeValueAsString(
                    buildRequestBody(symptoms, history != null ? history : new ArrayList<>(), stream));
    ...
    /** 构造请求体 */
    private Map<String, Object> buildRequestBody(String symptoms,
